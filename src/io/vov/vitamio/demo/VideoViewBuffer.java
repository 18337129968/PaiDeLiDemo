		...
		OnBufferingUpdateListener
{
	 ...
	 */
	private String[] path =
	{		 "/storage/sdcard1/Movies/test.avi",
			"/storage/emulated/0/bluetooth/Õı»ÿ - ªµΩ„Ω„.mp3" };

	// private String path = "/storage/sdcard1/Movies/test.avi";
	private Uri uri;
	...
	public void onCreate(Bundle icicle)
	{
		...
		position=extras.getInt("value") % 2;
		if (path[position] == "")
		{
